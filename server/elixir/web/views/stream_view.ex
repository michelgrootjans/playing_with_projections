defmodule Quizzy.StreamView do
    ...
    alias Quizzy.Events.{PlayerHasRegistered, QuizWasCreated, QuestionAddedToQuiz}
    ...
    def render_event(%QuestionAddedToQuiz{} = event) do
        %{event: "QuestionAddedToQuiz", data: event}
    end
end
